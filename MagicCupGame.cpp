...
// MagicCupGame.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMagicCupGameApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CMagicCupGameApp::OnAppAbout)
...
// Создание CMagicCupGameApp

CMagicCupGameApp::CMagicCupGameApp() noexcept
{
	...
	SetAppID(_T("MagicCupGame.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CMagicCupGameApp

CMagicCupGameApp theApp;


// Инициализация CMagicCupGameApp

BOOL CMagicCupGameApp::InitInstance()
{
	...
	{
		m_nCurrentUserID = loginDlg.m_nUserID;
	}
	else
	{
		return FALSE;
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CMagicCupGameDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CMagicCupGameView));
	if (!pDocTemplate)
		return FALSE;
...
int CMagicCupGameApp::ExitInstance()
{
...
// Обработчики сообщений CMagicCupGameApp
...
void CMagicCupGameApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
